...
def create_merged_train_dataset_info(data_preset_multi: dict, data_home: Optional[os.PathLike] = None):
    ...
    #print(f"Resolved data_home path: {data_home}")  # Debugging-Ausgabe
    #print(f"data_home received: {data_home}")
    #assert data_home is not None, "data_home is None. Please provide a valid path."
    #assert os.path.exists(data_home), f"Data home   path does not exist: {data_home}"
